...
struct CRGBW {
    ...
    {
        hsv2rgb_rainbow( CHSV(hue, 255, 255), *((CRGB*)this));
        return *this;
    }
    ...
    /// 'plain math' dimming rules, which means that if the low light levels
    /// may dim all the way to 100% black.
    inline CRGBW& nscale8 (const CRGB & scaledown )
    {
        r = ::scale8(r, scaledown.r);
        g = ::scale8(g, scaledown.g);
        b = ::scale8(b, scaledown.b);
    ...
    /// return a CRGB object that is a scaled down version of this object
    inline CRGBW scale8 (const CRGB & scaledown ) const
    {
        CRGB out;
        out.r = ::scale8(r, scaledown.r);
        out.g = ::scale8(g, scaledown.g);
    ...
    /// return a new CRGB object after performing a linear interpolation between this object and the passed in object
    inline CRGBW lerp8( const CRGB& other, fract8 frac) const
    {
        CRGBW ret;
